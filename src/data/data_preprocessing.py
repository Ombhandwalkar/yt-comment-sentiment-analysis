...
def preprocess_comment(comment:pd.DataFrame)->pd.DataFrame:
    try:
        # Convert strings lower case
...
# Peform above function 
def normalize_text(df:pd.DataFrame)-> pd.DataFrame:
    try:
        # Applying Processing comment on 'clean_comment' feature
